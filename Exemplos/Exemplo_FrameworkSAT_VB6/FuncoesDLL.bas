...
Public Declare Function AbreCupomCancelamento2 Lib "E1_SAT01.dll" (ByVal path_file As String, ByVal chCanc As String, ByVal CNPJ As String, ByVal signAC As String, ByVal numeroCaixa As Integer) As Long
...
Public Declare Function AbreCupomVenda2 Lib "E1_SAT01.dll" (ByVal path_file As String, ByVal versaoDadosEnt As String, ByVal CNPJ_SH As String, ByVal signAC As String, ByVal numeroCaixa As Integer, ByVal CNPJ_emit As String, ByVal IE As String, ByVal IM As String, ByVal cRegTribISSQN As String, ByVal indRatISSQN As String, ByVal CNPJ_dest As String, ByVal CPF_dest As String, ByVal xNome_dest As String) As Long
